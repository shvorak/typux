...
var PropertyInfo = /** @class */ (function (_super) {
    ...
    Object.defineProperty(PropertyInfo.prototype, "propertyType", {
        get: function () {
            return this.hasAttribute(index_1.typeKey)
                ? this.getAttribute(index_1.typeKey)
                : undefined;
        },
        enumerable: true,
        configurable: true
...
var ParameterInfo = /** @class */ (function (_super) {
    ...
    Object.defineProperty(ParameterInfo.prototype, "parameterType", {
        get: function () {
            return this.hasAttribute(index_1.typeKey)
                ? this.getAttribute(index_1.typeKey)
                : undefined;
